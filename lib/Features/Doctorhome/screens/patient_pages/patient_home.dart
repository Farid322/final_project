            ...
            SizedBox(height:46.h),
               const Align(
                  ...
                  Row(children: [
                    ...
                    SizedBox(width:67.w),
                    Text('1',style: AppStyels.s23.copyWith(color: Colors.yellow)),
                    SizedBox(width:67.w),
                    Text('12',style: AppStyels.s23.copyWith(color: Colors.orange)),
                  ],),
                  Row(
                    children: [
                      Text('Total sessions',style:AppStyels.s14.copyWith(color: Colors.grey)),
                      SizedBox(width: 7.w),
                      Text('Completed',style:AppStyels.s14.copyWith(color: Colors.grey)),
                      SizedBox(width:7.w),
                      Text('Delayed',style:AppStyels.s14.copyWith(color: Colors.grey)),
                      SizedBox(width: 7.w),
                      Text('Min hours',style:AppStyels.s14.copyWith(color: Colors.grey)),
                    ],
                  ),
                  ...
                  SizedBox(height:25.h),
                   ...
                   GoRouter.of(context).go(RouterNames.PatientMedicine);   
                    ...
                    text: 'My medicine',
                       ...
                       Row(
                        children: [
                          Text('My Doctor',style: AppStyels.s18.copyWith(color:Colors.grey )),
                          ...
                          children: [
                            Column(
                              children: [
                                ...
                                Text('Experience',style: AppStyels.s18.copyWith(color: Colors.grey)),
                                SizedBox(height:9.h),
                                Text('8 Years',style: AppStyels.s18.copyWith(fontWeight:FontWeight.normal)),
                                SizedBox(height:17.h),
                                const Custombutton(
                                            text: 'Details',
                             width:151,
                            ...
                            Padding(
                              ...
                              child: Image.asset('assets/images/5175-removebg-preview 1.png'),
                            )
                          ],
                        ),
                      ),
