...
class session extends StatefulWidget {
  ...
  @override
  State<session> createState() => _Paitentsession();
}

class _Paitentsession extends State<session> {
  @override
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.only(
                  top: 0, bottom: 10, left: 30, right: 20),
              child: Row(
                children: [
                  Container(
                    width: 103,
