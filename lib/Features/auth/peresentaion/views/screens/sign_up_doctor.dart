...
class SignUpdoctor extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocListener<SignupDoctorCubit, SignupDoctorState>(
        listenWhen: (previous, current) =>
          current is SignupDoctorSuccess || current is SignupDoctorFaliure,
          listener: (context, state) {
            if (state is SignupDoctorSuccess) {
            
              GoRouter.of(context).push(RouterNames.DoctorHome);
            } else if (state is SignupDoctorFaliure) {
        ...
        child: Scaffold(
          ...
          body: Padding(
            ...
            //        int intpassword =int.parse(_passWordController.text);
                      // int intconfirmpassword =int.parse(_confirmPasswordController.text);
                    //   int intexperience = int.parse(_experienceController.text);
                      return CustomButton(text: 'Log-In',onTap:() {
                        BlocProvider.of<SignupDoctorCubit>(context).DoctorSignup(
